...
### Downloading the trained CGP Generator from Hugging Face 🤗
You can skip the training by downloading and using our trained [CGP Generator](https://huggingface.co/xingshen/prompt4trust-cgpgenerator-1.5B).
