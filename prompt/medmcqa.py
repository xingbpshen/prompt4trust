...
downstream_model_part1 = """You must provide a NUMBER answer (1, 2, 3, or 4) and a CONFIDENCE score (0-100) in the last sentence of your response as "In conclusion, the answer is {LETTER} with confidence {CONFIDENCE}" """
